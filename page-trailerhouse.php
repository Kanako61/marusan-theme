...
<main class="l-contents-main page_main trailerhouse_main">

<section class="trailerhouse_main_img">
<!--main img-->
  <div class="page_title-pic trailerhouse_pic">
  <picture>
      <img src="<?php echo get_template_directory_uri(); ?>/trailerhouse/assets/images/main-img.webp" alt="新しいくらしの可能性を">
  </picture>
  <h1 class="catchcopy"><span class="en">Trailer House</span><span class="ja">新しいくらしの可能性を</span></h1>
</div>
</section>
...
<section class="about">
  <div class="about_inner">
    ...
    <div class="txtArea">
      <p class="u-txt u-align-c">トレーラーハウスとは、<br class="u-none--sp">移動可能な車両として登録される建築物の一種であり、<br class="u-none--sp">日本でも近年注目を集めています。<br>トレーラーハウスは、一般的な建築物とは異なり、車両扱いとなるため、<br class="u-none--sp">建築確認申請が不要であり、移動することが前提の設計となっています。<br>そのため、住居や事務所、店舗などに幅広い用途に対応し、<br class="u-none--sp">企業や個人のニーズに応じた柔軟な活用が可能です。</p>
    </div>
  </div>
</section>
...
<section class="features">
  ...
  <!--お問い合わせリンク-->
  <?php get_template_part('trailerhouse/parts/contact'); ?>
</section>
  ...
  <div class="marusan_trailerhouse_inner">
    ...
    <ul class="marusan_trailerhouse_list">
      <li class="marusan_trailerhouse_list_item">
        <div class="txtArea">
          <span class="en-num">Features01</span>
      ...
      <li class="marusan_trailerhouse_list_item">
        <div class="txtArea">
          <span class="en-num">Features02</span>
      ...
      <li class="marusan_trailerhouse_list_item">
        <div class="txtArea">
          <span class="en-num">Features03</span>
...
<section class="products">
  ...
  <div class="sumika products_box">
    ...
    <div class="products_txtArea">
      ...
      <p class="price">¥7,200,000〜 <span class="tax">(+Tax)</span></p>
    </div>

    <ul class="products_point_list">
  ...
  <div class="sumika products_box">
    ...
    <div class="products_txtArea">
      ...
      <p class="price">¥3,500,000〜 <span class="tax">(+Tax)</span></p>
    </div>

    <ul class="products_point_list">
      <li class="products_point_list_item">
        <p class="point u-align-c">POINT</p>
        <h3 class="item_tit u-align-c">手軽に移動できる<br>高い可能性</h3>
        <div class="item_img">
...
<section class="plus-One">
  ...
  <div class="plus-One_inner">
    ...
    <p class="txtArea top">sumika / meguriは木の温もりを感じるデザインと安心の品質で、<br>暮らし・事業・観光・災害対応と幅広く活用が可能です。</p>
    ...
    <ul class="plus-One_list">
      <li class="plus-One_list_item">
        ...
        <div class="txtArea">
          ...
          <p class="txt">自宅の離れとして、子供部屋や書斎、自宅サロンなど、多彩に利用できる木造トレーラーハウス。<br>心地よいデザインと温もりある空間が、あなたのライフスタイルに自由な使い方を提供します。</p>
        </div>
      </li>
      <li class="plus-One_list_item">
        <div class="imgArea">
        ...
        <div class="txtArea">
          ...
          <p class="txt">まちの中にあるトレーラーハウスは、待合所や期間限定の利用スペースに。<br>仮設的な利用に加え、災害時の避難所としての役割も果たし、地域の安心を支えます。</p>
        </div>
      </li>
      <li class="plus-One_list_item">
        <div class="imgArea">

      ...
      <div id="precut_01" class="offset"></div>
        <div class="slide">
          ...
          <dl class="slide-title">
            ...
            <dd class="c-text"><p>日本で古くから伝わる伝統的工法。現代の建築基準に合わせて発展してきました。大工職人が現場で行っていた仕口や継手の加工をマルサンの工場にて完全自動化。職人技を機械化することで、伝統的工法を受け継ぎ、現代の住宅建築の安全・効率化を根本から支えます。</p></dd>  
          </dl>
        </div>
      </li>
      ...
      <div id="precut_02" class="offset"></div>
        <div class="slide">
          ...
          <dl class="slide-title">
            ...
            <dd class="c-text"><p>在来工法における継手や仕口を金物同士によって接合させる工法。在来工法と比較すると、木材の断面欠損が少ない為、より高強度で安定した建築が可能です。金物は工場にてあらかじめ取り付けられ、現場ではドリフトピンを打つのみの為、熟練技術を必要としない施工が可能です。</p></dd>  
          </dl>
        </div>
      </li>
      ...
      <li class="swiper-slide swiper-slide-next" role="group" aria-label="7 / 10" style="width: 720px; opacity: 0; transform: translate3d(-4320px, 0px, 0px); transition-duration: 0ms;">
        ...
        <div class="slide">
          ...
          <dl class="slide-title">
            ...
            <dd class="c-text"><p>在来工法に加えて構造用合板を用いて耐震性向上を図る工法です。構造用合板と柱材等を組み立てることでパネルを作成します。パネルにあらかじめ断熱材を接着するため、現場での工期短縮や気密・断熱性能の向上を実現します。また、あらゆるパネル工法にも対応が可能です。</p></dd>  
          </dl>
        </div>
      </li>
      ...
      <li class="swiper-slide swiper-slide-next" role="group" aria-label="7 / 10" style="width: 720px; opacity: 0; transform: translate3d(-4320px, 0px, 0px); transition-duration: 0ms;">
        ...
        <div class="slide">
          ...
          <dl class="slide-title">
            ...
            <dd class="c-text"><p>2×4材を用いて枠組を作成し、構造用合板を用いてパネルを構成していきます。床・壁・屋根を一体化させ「六面体構造」を形成することで高い耐震性と耐久性を実現可能です。マルサンの工場にてパネルを作成するため、現場ではパネルを組み合わせるだけで施工が可能になります。</p></dd>  
          </dl>
        </div>
      </li>
    </div>

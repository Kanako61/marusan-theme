...
<section class="page_section page_precut">
  ...
  <p>今や日本の木造住宅建築では当たり前となったプレカットは1995年の阪神・淡路大震災からの復興を機に一気に普及しました。1935年の創業以来一貫して木造建築に携わってきたマルサンでは、将来のプレカット需要を見据えて東北地区では最初期である1989年にプレカット工場を設立しました。以来、35年以上に渡ってプレカットの先駆者としてその普及に尽力してまいりました。対応可能な工法は在来工法だけでなく、多くの金物工法やパネル工法、2×4工法にも対応しております。また、プレカットのみならず、吹付断熱材の施工や建方工事の請負、さらには構造計算などにも対応し、木造建築を多方面からサポート、ご提案いたします。や建方工事の請負など、住宅建築を多方面にてサポート、ご提案致します。</p>
</section>
    ...
    <ul class="swiper swiper-fade swiper-initialized swiper-horizontal swiper-pointer-events swiper-watch-progress swiper-backface-hidden precut_list_c">
      ...
      <div id="precut_01" class="offset"></div>
        <div class="slide">
          ...
          <dl class="slide-title">
            <dt class="c-tit">在来工法</dt>
            <dd class="c-text"><p>日本で古くから伝わる伝統的工法。<br>現代の建築基準に合わせて発展してきました。大工職人が現場で行っていた仕口や継手の加工をマルサンの工場では全面的に機械加工化。職人技を機械化することで、伝統的工法を受け継ぎ、現代の木造建築の安全と効率化を文字通り土台から支えています。</p></dd>  
          </dl>
        </div>
      </li>
      ...
      <div id="precut_02" class="offset"></div>
        <div class="slide">
          ...
          <dl class="slide-title">
            <dt class="c-tit">金物工法</dt>
            <dd class="c-text"><p>在来工法における継手や仕口の接合を金物によって置き換えた工法。在来工法と比較すると、木材の断面欠損が少ない為、より高強度で安定した建築が可能です。金物は工場にてあらかじめ取り付けられ、現場ではドリフトピンを打つのみの為、熟練技術を必要としない施工が可能です。マルサンは主要な金物工法のほとんどに対応しています。</p></dd>  
          </dl>
        </div>
      </li>
      ...
      <li class="swiper-slide swiper-slide-next" role="group" aria-label="7 / 10" style="width: 720px; opacity: 0; transform: translate3d(-4320px, 0px, 0px); transition-duration: 0ms;">
        ...
        <div class="slide">
          ...
          <dl class="slide-title">
            <dt class="c-tit">パネル工法</dt>
            <dd class="c-text"><p>在来工法に加えて、あらかじめ工場で製作する木製のパネルを用いて耐震性向上を図る工法です。<br>パネルは構造用合板と床や壁を構成する枠材を組み立てることで作成します。床や壁のパネルにはあらかじめ断熱材を接着することもでき、現場での工期短縮と建物の気密性や断熱性能の向上を実現します。</p></dd>  
          </dl>
        </div>
      </li>
      ...
      <li class="swiper-slide swiper-slide-next" role="group" aria-label="7 / 10" style="width: 720px; opacity: 0; transform: translate3d(-4320px, 0px, 0px); transition-duration: 0ms;">
        ...
        <div class="slide">
          ...
          <dl class="slide-title">
            <dt class="c-tit">2×4工法</dt>
            <dd class="c-text"><p>2×4材を用いた枠組と構造用合板と組み合わせてパネルを構成し、床・壁・屋根を一体化させ「六面体構造」を形成することで高い耐震性と耐久性を実現する工法です。マルサンの工場にてパネルを作成するため、現場ではパネルを組み合わせるだけで施工が可能になり、工期短縮と大工職人の技量に影響されない品質を実現します。</p></dd>  
          </dl>
        </div>
      </li>
    </div>
...
<section class="page_section page_other-precut">
  <dl class="page_other-precut_inner">
    ...
    <dd>住宅を取り巻く環境は時代と共に大きく変化してきました。住宅ニーズや働き手の環境、法改正など、住宅産業全体が様々な変化に対応していく必要が出てきています。平成元年のプレカット工場設立以来、マルサンでは住宅建築を多方面からサポート出来るように様々な事業を展開し続けています。</dd>
  </dl>

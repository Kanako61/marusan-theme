...
<dl class="effort_text_dl">
    ...
    <dd>昭和10年創業以来、マルサンは住宅を取り巻く様々な課題やニーズに応えるべく数多くのサービスを創造してまいりました。2016年に掲げた「<span class="blue">明日の家づくりを創る</span>」というスローガンのもと、住宅業界の「<span class="blue">人手不足の解消</span>」「<span class="blue">木造住宅の性能向上</span>」といった課題解決に貢献しています。<br>
...
item-04">
    ...
    <div class="list_item_inner-02">
        <p class="item-01_text01">プレカット加工時に通常は廃棄する端材やおがくずが必ず発生します。マルサンでは短くなった端材を繋ぎ合わせ再生材を製品化しています。他にも家庭用暖房の燃料として地域の一般家庭に販売したり、おがくずは畜産農家に提供し堆肥等に再利用しています。各種設備更新では積極的に省エネ設備を採用し、エネルギー使用量も削減。<br>木材の有効利用と省エネによって、CO2排出量の抑制にも取り組んでいます。</p>
